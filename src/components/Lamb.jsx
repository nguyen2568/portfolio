...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-150 flex-col items-center justify-center overflow-hidden w-full rounded-md z-0",
        className
      )}>
      <div
        ...
        <div
          className="absolute top-1/2 z-50 h-30 w-full bg-transparent opacity-10 backdrop-blur-md"></div>
        <div
        ...
        <div
          className="absolute inset-auto z-40 h-44 w-full dark:bg-gray-900 -translate-y-[12.5rem] "></div>
      </div>
